export const talles = [
   ...
   
    {
      ...
      items: [
        //  { id: 'S', label: 'S (Ancho:61cm - Alto:68cm)' },
        // { id: 'M', label: 'M (Ancho:63cm - Alto:70cm)' },
        // { id: 'L', label: 'L (Ancho:65cm - Alto:72cm)' },
        // { id: 'XL', label: 'XL (Ancho:67cm - Alto:74cm)' },
        // { id: 'XXL', label: 'XXL (Ancho:69cm - Alto:76cm)' },
      ],
    },
  ];
